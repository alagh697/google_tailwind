...
export default function Home() {
  ...
  return (
    <div className='flex flex-col items-center justify-center h-screen'>
      <Head>
        <title>Google Tailwind NextJS</title>
      ...
      <header className="flex w-full p-5 justify-between text-lg text-gray-700">
        ...
        <div className="flex space-x-4 items-center">
          ...
          <ViewGridIcon className="h-10 w-10 p-2 rounded-full hover:bg-gray-200 
          cursor-pointer" />

          <Avatar url="https://i.pinimg.com/originals/a9/6a/48/a96a4848099928ff427e621a3f923afa.png" />
        </div>
      </header>
